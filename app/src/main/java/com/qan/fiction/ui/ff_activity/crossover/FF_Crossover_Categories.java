...
public class FF_Crossover_Categories extends Categories {
    ...
    public ListFragment getNextFragment(int position) {
        return new FF_Crossover_Categories2();
    }


    @Override
    public String getUrl() {
        return "https://fanfiction.net/crossovers/" + getArguments().getString("append");
    }

    @Override
    public String getMobileUrl() {
        return "https://m.fanfiction.net/crossovers/" + getArguments().getString("append");
    }
